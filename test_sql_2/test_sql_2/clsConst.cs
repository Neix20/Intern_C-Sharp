...
namespace test_sql_2
{
    public class clsConst
    {
        ...
        public static string Prefix_Voucher = "VV";
        ...
        public static int TransactionType_VoucherTopup = 12;
        public static int TransactionType_PuzzleRedeem = 8;
        public static int TransactionType_Campaign = 9;
        //'Staging
        ...
        public static bool const_IsMerchant = false;
        ...
        // staging
        //public static bool const_Live = false;
        ...
        //public static string SysDBConnString = "data source=DESKTOP-HOU9836\\VMS;initial catalog=test_vms;user id=Staging_vms; password=Nomoneynotalk88";
        //public static string SysDBConnString = "data source=47.254.234.86;initial catalog=vms;user id=sa; password=Nomoneynotalk88!";
        //public static string SysDBConnString = "data source=47.254.234.86;initial catalog=vms;user id=sa; password=Nomoneynotalk88!";
        public static string SysDBConnString()
        {
            string DBConn = "Data Source=IVD-LT-TANXIEN;Initial Catalog=dbJavaSelenium;Integrated Security=True;user id=IVD-LT-TANXIEN\\TanXiEn";
            return DBConn;
        }

        public static string SysDBConnString_Voucher()
        {
            string DBConn_Voucher = "data source=47.254.234.86;initial catalog=VendingCampaign;user id=sa; password=Nomoneynotalk88!";
            //if (const_Live)
            //{
            //    DBConn_Voucher = "data source=47.254.234.86;initial catalog=VendingCampaign;user id=sa; password=Nomoneynotalk88!";
            //}
            //else
            //    DBConn_Voucher = "data source=47.254.234.86;initial catalog=VendingCampaign;user id=sa; password=Nomoneynotalk88!";
            return DBConn_Voucher;
        }
        //public static string SysDBConnString = "data source=47.254.234.86;initial catalog=vms_Test;user id=sa; password=Nomoneynotalk88!";
        ...
        public const string const_FunctionCode_Event = "4007";
        public const string const_FunctionCode_Upload = "4008";
